    ...
    <footer ref={ref} className="border-t border-zinc-800 bg-zinc-950">
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="mt-4 flex items-center justify-center gap-5">
          <a href="/termeni" className="text-xs text-zinc-500 hover:text-white transition-colors underline underline-offset-2 decoration-zinc-700">
            Termeni și Condiții
          </a>
          <span className="text-zinc-600 text-xs">·</span>
          <a href="/confidentialitate" className="text-xs text-zinc-500 hover:text-white transition-colors underline underline-offset-2 decoration-zinc-700">
